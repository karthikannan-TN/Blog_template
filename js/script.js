            ...
            <div class="row justify-content-center">
              <div class="col-12 text-center footer-content">
                <div class="footer-title text-white">
                  <h1 class="fw-bold">Cafe Madurai.</h1>
                  <ul class="list-unstyled text-uppercase">
                    <li>open from 07:00 AM - 11:00 PM</li>
                    <li class="mb-3">Madurai,Tamilnadu</li>
                  </ul>
                  <span class="me-3"><i class="fa-brands fa-instagram"></i> Cafe Madurai</span>
                  <span><i class="fa-brands fa-whatsapp"></i>787878787</span>
                </div>
              </div>
            </div>
            <div class="text-footer text-white text-center">
              <p class="m-0">
                Created with <i class="fa-solid fa-heart text-danger"></i> by <a href="https://www.instagram.com" target="_blank" class="text-warning">Karthi Kannan S</a> © 2024 Copyright | All Rights Reserved
              </p>
            </div>
          </div>`;
}
