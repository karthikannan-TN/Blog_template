...
function textCoffee() {
  menuText1.textContent = "Our Drink";
  menuText2.textContent = "Choose Your";
  menuText3.textContent = "Favorite Drink";
  menuText4.textContent = "More than 30+ type of Drink are ready to serve by our professionals.";
  menuList1.textContent = "Mor";
  menuList2.textContent = "Jigirthanda";
  menuList3.textContent = "Panakaram";
}
function textDesserts() {
  ...
  menuList1.textContent = "Boli";
  menuList2.textContent = "Paalkova";
  menuList3.textContent = "Kesari";
}
function textBreakfast() {
  ...
  menuList1.textContent = "dosa";
  menuList2.textContent = "aapam";
  menuList3.textContent = "pongal";
}
